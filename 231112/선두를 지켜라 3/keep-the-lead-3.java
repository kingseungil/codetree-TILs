...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String lead = "none";
        Map<Integer, String> map = new HashMap<>(); // {time, lead}
        ...
        int count = 0;
        // lead가 바뀔때마다 count 증가
        for (int i = 0; i < distancePerTime1.length - 1; i++) {
            if (!map.get(i).equals(map.get(i + 1))) {
                count++;
            }
        }
        System.out.println(count - 1); // 0초일때 lead가 바뀌는 것은 count하지 않음
    }
